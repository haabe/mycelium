...
```
   ...
   user + agent  ◄────► │ diamonds · scales L0–L5 · theory gates · routing  │
             ...
             └───────────────────────────────────────┘   └─────────────────────────┘
                                   ...
                                   ▼
                        ┌──────── skills (operations) ─────────┐
                        │ 62 skills, auto-loaded from SKILL.md │
                        └─────────────────────────────────────┘
```
...
| **Skills** | 62 skills, invocable as `/mycelium:<name>`, auto-discovered from SKILL.md frontmatter | `plugins/mycelium/skills/` | inferential |
