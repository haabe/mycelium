...
Alternate index to the phase-first [skills/README.md](README.md). Same 61 skills, different ordering.
...
- [README.md](README.md) — phase-first index of the same 61 skills
