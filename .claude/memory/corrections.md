...
- **Cost framing**: At Pro-tier rate-limit scale (per Frida thread in auto-memory — attribution to Mycelium-specific use unconfirmed), ~14k wasted tokens per canvas-writing skill is the kind of cost that turns adoption into abandonment. This is not just a discipline question; it's a token-economy question. F1 has measurable user-facing cost reduction.
