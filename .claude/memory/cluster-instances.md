...
**Total instances:** 13 (as of 2026-05-23, late session — two same-session additions surfaced via BVSSH-on-l0-purpose run; instance 13 introduces a new sub-shape `canvas-state-vs-reality-drift`)
...
**Total instances:** 8+ catalogued across both repos (framework public corrections.md + roadmap private corrections.md). Sub-class distribution skews to conversational + self-application; canvas-write enforcement layer (v0.22.0) reduced canvas-write recurrence but did not eliminate adjacent surfaces.
