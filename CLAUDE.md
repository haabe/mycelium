...
*Version 0.117.3 -- **Attribution label: the-cadence-was-the-tell-2026-08-21**. **MEASURED, THEN CUT.** Two blind readers scored the README 6/10 and 7/10 machine-written and both named *What it feels like*; rewriting it moved that section 9/10 to 4/10 and **moved the file not at all**, because the dominant tell was distributed: **fourteen instances of not-X-but-Y**, in every prose section. Thinned to a handful, and with them went a bolded tagline carrying no argument, an invented line of agent dialogue, four terminal maxims, and six semicolons doing em-dash work. **One em-dash left in the file, down from three.** **THE THING BOTH READERS ASKED FOR FIRST WAS NOT PROSE**: the README showed no output at all. It now names the six directories setup creates and points at a stranger's public repo where the canvas, diamond and decision log are left in on purpose. **1,813 words against 1,815 before any of this** — the cuts paid for the addition.*
