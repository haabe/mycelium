...
*Version 0.57.1 -- **Attribution label: docs-drift-skillcount-2026-07-18** (roadmap dogfood — documentation drift sweep). **Docs-drift patch**: corrected stale skill counts (49 / 55 / "45+" → **58**) across `context-surface.md` and the Codex / Cursor / opencode integration docs, and fixed a dead `v0.15.x` "framework-health not yet executed" claim in `ai-system-card.md` (framework-health has run repeatedly; last 2026-07-05). The opencode engine/harness-reference measurement was re-measured and refreshed to 33 of 58 (runtime-verified 2026-07-18). Historical version tokens, deprecations, and dated receipts were checked and left untouched; no dead paths or phantom skill names found. **Priors**: v0.57.0 **harms-check-gate-2026-07-11** (new `/harms-check` design-time safety gate — dark/deceptive patterns + foreseeable misuse, the BVSSH-**Happier** front-end), v0.56.3 **canvas-health-reopened-at-2026-07-05** (`reopened_at` counts as task activity), v0.56.2 **install-command-drift-2026-07-04** (slash marketplace ref fixed across 53 skill notes + Check 46) (see `docs/changelog.md`).*
