...
*Version 0.23.27 -- **Attribution label: external-validation-triggered**. README adds "Where it sits in the field" section citing the two canonical "harness engineering" vocabulary anchors (Fowler/Böckeler 2026-04-02 + Ning et al. arxiv 2605.18747 2026-05-18). Honest framing: Mycelium is one worked example of the family-of-mechanisms; the family is consensus-forming, the substrate choice and gating discipline are Mycelium's own design. Date-anchored citation; specifically avoids "Mycelium IS the answer" overclaim per anti-pattern #7 discipline. Tracking schedule for the time-bound positioning claim lives in roadmap-repo memory (3-month + 6-month rechecks). PATCH per version-discipline: README addition + this version line + changelog entry; no schema, skill, or behaviour change.*
