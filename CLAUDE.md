...
*Version 0.49.16 -- **Attribution label: readme-receipts-rotation-2026-06-18** (closes `/framework-health` 4c — the last open highlights-rotation recommendation). README "How Mycelium got smarter" highlights rotated: the 2026-05-09 plugin-form-dogfood case rotates off the README (it stays in `docs/receipts/cases/`), replaced by **2026-06-18-legacy-path-rot-guard** — fresher and a sharper instance of the same "a green check still hid real rot" lesson, so the five-case set keeps its thematic range. Docs only. **PATCH**. **Priors**: v0.49.15 **scope-expansion-guardrail-receipts-backfill-2026-06-18** (G-P9 scope-expansion checkpoint + receipts index backfill), v0.49.14 **pre-push-delivery-gate-2026-06-18** (see `docs/changelog.md`).*
