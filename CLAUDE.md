...
*Version 0.16.1 -- Patch on 0.16.0: Check 26 refined to WARN on uncommitted post-bump material edits (was incorrectly short-circuiting PASS); .claude/tests/ added to watched material paths (tests are framework code); AGENTS.md surfaces upgrade.sh + version-bump caveat for downstream agents that couldn't find it.
