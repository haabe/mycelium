...
*Version 0.39.11 -- **Attribution label: readme-ai-aesthetic-prose-sweep-2026-06-05**. README revised in four places to break evenly-smoothed parallel structures that read AI-aesthetic to craft readers (cohort-tester friction, voice-revise-framework-doc Layer 4). Lines 7, 22, 36, 73: dropped filler "with a strong purpose"; broke a four-WH-clause list with sentence-break and asymmetric phrasing; collapsed a balanced three-fragment trio into compress-and-erupt; split a four-verb chain into three-plus-stinger. Mechanical layer was already clean (zero em-dashes, zero banned AI-tell words); pass targets cadence and structure only. **PATCH** (docs only, no skill or engine or hook changes). **Prior**: log-evidence-untracked-channel-backfill-2026-06-05 (v0.39.10); poison-detector-rejected-alts-exclusion-2026-06-04 (v0.39.9).*
