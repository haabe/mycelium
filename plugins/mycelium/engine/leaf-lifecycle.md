...
- Ellis: ICE scoring (Impact, Confidence, Ease — averaged, not multiplied; `docs/errata.md` §A). Gilad: Evidence-Guided (Confidence Meter — evidence-grading layer on Ellis's ICE)
