...
- **Catalogued sub-classes** (8+ instances across both repos as of 2026-05-23 — full instance log in `.claude/memory/cluster-instances.md#consistency-as-evidence`):
  ...
  - **(e) subagent-output-verification** — agent accepts a subagent's specific claim about Mycelium files/fields and propagates it in synthesis without grep/Read verification. Pending graduation; agent-protocol fix logged.
